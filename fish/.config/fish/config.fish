...
# ----------------------------------------------------------------------------
# Dotfiles Directory (auto-detected from symlink)
# ----------------------------------------------------------------------------
set -gx DOTFILES_DIR (realpath (status filename) | string replace -r '/fish/\.config/fish/config\.fish$' '')
...
# set -gx OLLAMA_HOST server.example:11434
